  ...
  useEffect(() => {
    async function setupContainer() {
      ...
      try {
        ...
        // Use mountFiles from WebContainerService for consistency
        const WebContainerService = (
          await import("../service/webContainerService")
        ).default;
        await WebContainerService.mountFiles(files);
        console.log(await instance.fs.readdir("."));
        setLoadingState((prev) => ({
          ...prev,
          mounting: false,
          installing: true,
